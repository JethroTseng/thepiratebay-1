...
var TorrentComponent = /** @class */ (function () {
    function TorrentComponent(_jsonp, _piratebay) {
        this._jsonp = _jsonp;
        this._piratebay = _piratebay;
    }
    ...
    TorrentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Jsonp */], __WEBPACK_IMPORTED_MODULE_2__services_piratebay_service__["a" /* PiratebayService */]])
    ], TorrentComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_errors_not_found_error__ = __webpack_require__("../../../../../src/app/components/errors/not-found-error.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PiratebayService = /** @class */ (function () {
    function PiratebayService(_jsonp, _http) {
        this._jsonp = _jsonp;
        this._http = _http;
    ...
    PiratebayService.prototype.handleError = function (error) {
        if (error.status === 404) {
            return __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["a" /* Observable */].throw(new __WEBPACK_IMPORTED_MODULE_7__components_errors_not_found_error__["a" /* NotFoundError */]());
        }
    ...
    PiratebayService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__angular_http__["b" /* Jsonp */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]])
    ], PiratebayService);
